...
<html>
	...
	<title>Admin - PT Salwana Global Sarana</title>
	...
	<!-- Font Sans Google -->
	<link rel="stylesheet" href="<?=base_URL()?>assets/backend/components/font-google/sans-google.css">
	...
	<link rel="stylesheet" href="<?=base_URL()?>assets/backend/components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
	<!-- Select2 -->
	...
	<!-- Theme style -->
	<link rel="stylesheet" href="<?=base_URL()?>assets/backend/adminlte/css/AdminLTE.min.css">
	<!-- AdminLTE Skins. Choose a skin from the css/skins
		folder instead of downloading all of them to reduce the load. -->
	<link rel="stylesheet" href="<?=base_URL()?>assets/backend/adminlte/css/skins/skin-green.min.css">
...
<!-- Logo -->
	...
	<span class="logo-mini"><b>SP</b>U</span>
	<!-- logo for regular state and mobile devices -->
	<span class="logo-lg"><b>SIP</b> UMROH</span>
	</a>
		...
		<div class="navbar-custom-menu">
			...
			<li class="dropdown user user-menu">
				<a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
					<img src="<?=base_URL().'assets/backend/images/admin/'.$foto?>" class="user-image" alt="Foto Profil">
					<span class="hidden-xs"><?=$usr['nama_admin']?></span>
				</a>
			<ul class="dropdown-menu">
			<!-- User image -->
			<li class="user-header">
				<img src="<?=base_URL().'assets/backend/images/admin/'.$foto?>" class="img-circle" alt="Foto Profil">
			...
			<li class="user-footer">
				...
				<div class="pull-right">
					<a href="<?=base_URL()?>keluar" class="btn btn-default btn-flat">Sign out</a>
				</div>
			</li>
		</ul>
	</li>
